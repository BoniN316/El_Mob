        ...
        switch ($property['type']) {
          ...
          case 'select': {
              ...
              if ($property['type_view'] == 'select' || empty($property['type_view']) ||$property['type_view']=='type_view') {
                ...
                $html .= '<p class="select-type"><span class="property-title">'.$property['name'].': </span> <select name="'.$property['name'].'" class="last-items-dropdown">';
          ...
          case 'assortment': {
              ...
              if ($property['type_view'] == 'select' || empty($property['type_view']) || $property['type_view'] == 'type_view') {
                ...
                $htmlSelect = '<p class="select-type"><span class="property-title">'.$property['name'].': </span><select name="'.$property['name'].'" class="last-items-dropdown">';
