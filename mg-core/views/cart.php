...
<div class="product-cart" style="display:<?php echo!$data['isEmpty']?'none':'block'; ?>">
  <div class="cart-wrapper">
    ...
    <div class="total-sum">
      <span> Проверьте количество, нажмите Пересчитать </span><button type="submit" name="refresh" id="krzRefr2" class="refresh" title="Пересчитать" value="Пересчитать">Пересчитать</button>  <span>Стоимость всех товаров:</span>
