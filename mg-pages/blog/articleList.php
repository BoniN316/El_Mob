...
<div class="mg-main-news-block">
  ...
  <a href="<?php echo SITE;?>/blog/" class="blog_root"><?php echo $options['root_category_title']?></a>
  <?php endif;?>
  ...
  <div class="mg-main-news-item">
    <?php if ($arItem['image_url']): ?>
      <a href="<?php echo SITE . $arItem['path']; ?>" class="mg-list-news-img">
        <img src="<?php echo SITE . $data['img_path'] . 'thumbs/70_' . $arItem['image_url']; ?>" alt="<?php echo $arItem['title']; ?>" title="<?php echo $arItem['title']; ?>">
      </a>
    <?php endif; ?>
