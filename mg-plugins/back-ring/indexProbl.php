...
class BackRing
{
    ...
    private static $pluginName = 'back-ring'; // название плагина (соответствует названию папки)

    private static $path = '/mg-plugins/back-ring/'; //путь до файлов плагина
...
mgAddMeta('<link rel="stylesheet" href="'.SITE.'/'.self::$path.'/css/style.css" type="text/css" />');
 ...
 mgAddMeta('<link rel="stylesheet" href="'.SITE.'/mg-admin/design/css/jquery-ui.css">');
     ...
     */
    public static function preparePageSettings()
    {
        echo '
     ...
     */
    public static function getEntity($count = 1)
    {
        $result = array();
     ...
     */
    public static function getEntityActive()
    {
        $exist = false;
    ...
    public static function handleShortCode()
    {
        ...
        $html = "
    <div class='wrapper-back-ring'><a class='back-ring-button default-btn' href='javascript:void(0);'><img class='img_ring_back' src='/uploads/phYel.png' alt='обратный звонок фото'/></a>
    <a class='back-ring-button default-btn' href = 'javascript:void(0);'>Обратный звонок</a>
    </div>";
        $html .= "
     ...
     */
    public static function saveOrderRing($array)
    {
