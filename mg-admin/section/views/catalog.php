    ...
    <div class="widget-table-body">
      <div class="widget-table-action">
        ...
        <div class="mg-catalog-search">
            <input type="text" name="search" value="<?php echo $lang['FIND'];?>..." onfocus="if (this.value == '<?php echo $lang['FIND'];?>...') {this.value = '';}" onblur="if (this.value == '') {this.value = '<?php echo $lang['FIND'];?>...';}" class="custom-input search-input"/>
      ...
      <div class="import-container">
        ...
        <div class="block-importer">
          ...
          <div class="delete-all-products-btn"><label><input type="checkbox" name="no-merge" class="" title="<?php echo $lang['CLEAR_BEFORE_CSV'];?>"  value="false"><?php echo $lang['DEL_ALL_PROD'];?></label></div>
            ...
            <div class="add-product-form-wrapper">
              ...
              <div class="add-img-form">
                ...
                <div class="product-text-inputs">
                 ...
                 <span class="custom-text" style="margin-bottom: 10px;"><?php echo $lang['DESCRIPTION_PRODUCT'];?>:</span><!--Описание товара-->
                  <a href="javascript:void(0);" class="html-content-edit"><?php echo $lang['DESCRIPTION_PRODUCT_EDIT'];?></a><!--Редактирование товара-->
               ...
               <button class="save-button tool-tip-bottom" title="<?php echo $lang['T_TIP_SAVE_PROD'];?>"><span><?php echo $lang['SAVE'];?></span></button>
                ...
                <!--Блок для редактирования галереии продуктов ** разделен 26 сентября 2017 г. на две части. 1 часть с лейбами и окном редактирования перенесена на стр 416 настоящего файла для удобства ввода и закомментирована в оригинале на стр.429-430. 2 часть -Оригинал -сохранен на своем месте для вывода блока *с этим товаром покупают*. css сохранен оригинальный. textarea из стр.418-420 лучше не убирать, т.к. табло редактирования товара уходит вниз, что крайне неудобно Добавлена кнопка СОХРАНИТЬ для удобства. Она дублирует оригинальную кнопку внизу станицы . Верхняя - только для сохранения описания-->
        ...
        <div class="product-table-wrapper">
            ...
            <div class="widget-table-body">
                <div class="property-value custom-textarea-value">
                    <textarea name="html_content-textarea" style="margin: 0px; width: 808px; height: 555px;"></textarea><!--Это око ред.Инструкций-->
                </div>
                <div class="save">
  ...
  <!-- Тут заканчивается Верстка модального окна -->
    ...
    <div class="wraper-fast-result hidden-form yml-link-was-formed">
        <div class="product-table-wrapper">
            ...
            <a href="javascript:void(0);" target="_blank" class="yml-link"></a>

            <div class="link-name">
                <span><?php echo $lang['NAME_OF_LINKYML'] . ' ' . SITE . '/' ?></span>
