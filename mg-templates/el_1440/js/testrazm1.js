...
var rzdprod;
var rzdpokr;
var wdthH=document.documentElement.clientWidth;
if (document.getElementById('rzdMat')!==null )
{rzdprod=true;
 rzdpokr=false;
}
...
if (urllE==="https://moguta.elakor-floor.ru/prays-list") {
document.querySelector('main').style="margin-top: -24vh;";
if (wdthH<350) {
document.querySelector('main').style="margin-top: -67vh;";}
}

}
if (urllE==="https://moguta.elakor-floor.ru/obraztsy-betonov") {

if (wdthH<350) {
document.querySelector('main').style="margin-top: -27vh;";
var etd=document.querySelectorAll('td');
var stl="";
for (let i = 0; i <etd.length; i++) { // выведет 0, затем 1, затем 2
 etd[i].style=stl;
}
}
}
...
if (wdthH<350) {
document.getElementById('skl1ul').style="";
document.querySelector('main').style="margin-top: -41vh;";
}
}
if (urllE==="https://moguta.elakor-floor.ru/obekty/poly-dlya-tseha") {
if (wdthH<350) {
document.querySelector('main').style="margin-top: -21vh;";
}
}
if (urllE==="https://moguta.elakor-floor.ru/obekty/poly-dlya-ofisa") {
if (wdthH<350) {
document.querySelector('main').style="margin-top: -21vh;";
}
}
...
if (urllE==="https://moguta.elakor-floor.ru/tablitsa-tsvetov") {
if (wdthH<350) {
document.querySelector('main').style="margin-top: -46vh;";

}else{
document.querySelector('main').style="margin-top: -23vh;";}
}

if (urllE==="https://moguta.elakor-floor.ru/poly/betonnye-poly") {
if (wdthH<350) {
document.querySelector('main').style="margin-top: -79vh;";

}else{
document.querySelector('main').style="margin-top: -23vh;";}
}

if (urllE==="https://moguta.elakor-floor.ru/poly/polimernye-poly") {
if (wdthH<350) {
document.querySelector('main').style="margin-top: -133vh;";
...
if(rzdprod===true) {
  if (wdthH<350) {
document.querySelector('main').style="margin-top: -32vh;";

}else{
document.querySelector('main').style="margin-top: -10vh;";}
var elem=document.querySelectorAll('img');
...
var elem=document.getElementsByClassName('AttentYl')[0].style="";
console.log("main",document.querySelector('main').style,rzdprod);

}
if(rzdpokr===true){

if (wdthH<350) {
document.querySelector('main').style="margin-top: -45vh;";

}else{
document.querySelector('main').style="margin-top: -10vh;";}

var elem=document.querySelector('div.AttentYl').style="";
console.log("document.querySelector('div.AttentYl')  ",document.querySelector('div.AttentYl') );
}
