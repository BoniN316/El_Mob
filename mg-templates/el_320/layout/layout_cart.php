...
<?php if(MG::getOption('popupCart')=='true'){ ?>
  ...
  <div class="mg-layer" style="display: inline-block;"></div>
  <div class="mg-fake-cart" style="display: inline-block;">
...
<div class="mg-desktop-cart">
  <div class="cart">
    <div class="cart-inner">
      ...
      <div class="cartright">
        <a id="mkorzA" href="<?php echo SITE ?>/cart" title="Корзина"> 
        <p class="cart_p <?php if(! empty($data['cartData']['dataCart'])) echo 'cart_hide'; ?>" >Ваша корзина <br>пока пуста</p>
        <ul class="cart-list <?php if(empty($data['cartData']['dataCart'])) echo 'cart_hide'; ?>">
          <li class="cart-qty">
            <span class="countsht"><?php echo $data['cartCount']?$data['cartCount']:0 ?></span> кг. -
