...
<input type="checkbox" id="polKf" onclick="accord()">
 <label for="polKf" > Согласие на обработку моих персональных данных</label>
      <div class="checkout-form-wrapper" id="cfwpkf">
        <?php if($data['msg']): ?>
          <div class="mg-error">
        <?php echo $data['msg'] ?>
          </div>
        ...
        <div class="payment-option">
          ...
          <form action="<?php echo SITE ?>/order?creation=1" method="post">
            <ul class="form-list">
              ...
              <li style="display:none;">Адрес доставки:</li>
              <li style="display:none;"><textarea class="address-area" name="address"><?php echo $_POST['address'] ?></textarea></li>
